module Erp
  module ApplicationHelper
    ...
    def erp_datalist_check_all
      '<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline"><input type="checkbox" class="group-checkable datalist-checkbox-all"/><span></span></label>'.html_safe
    end

    def erp_datalist_check_row(options={})
      ('<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline"><input type="checkbox" class="checkboxes datalist-row-checkbox" name="ids[]" value="'+options[:id].to_s+'" /><span></span></label>').html_safe
    end
